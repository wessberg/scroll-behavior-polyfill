...
export function computeScrollIntoView(
  target: Element,
  scroller: Element,
  ...
  const viewportWidth =
    window.visualViewport != null ? visualViewport.width : innerWidth;
  const viewportHeight =
    window.visualViewport != null ? visualViewport.height : innerHeight;

  const viewportX =
    window.scrollX != null ? window.scrollX : window.pageXOffset;
  const viewportY =
