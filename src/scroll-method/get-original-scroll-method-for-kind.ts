 ...
 * @param {number} y
 */
function elementPrototypeScrollFallback(
  this: IAdjustableElement,
  x: number,
  y: number
): void {
 ...
 * @param {number} y
 */
function elementPrototypeScrollToFallback(
  this: IAdjustableElement,
  x: number,
  y: number
): void {
 ...
 * @param {number} y
 */
function elementPrototypeScrollByFallback(
  this: IAdjustableElement,
  x: number,
  y: number
): void {
 ...
 * @return {Function}
 */
export function getOriginalScrollMethodForKind(
